...
from tensorflow.keras.layers import Dense, Dropout, BatchNormalization, Conv1D, Flatten, Input, Add
...
# callbacks
mcp_save = keras.callbacks.ModelCheckpoint('saved_models/cnn_res_oh.h5', save_best_only=True, monitor='val_accuracy', verbose=1)
reduce_lr = keras.callbacks.ReduceLROnPlateau(monitor='val_accuracy', factor=0.1, patience=5, verbose=1, mode='auto', min_delta=0.0001, cooldown=0, min_lr=0)
callbacks_list = [reduce_lr, mcp_save]
# model = load_model('cnn_oh.h5', custom_objects = {'sensitivity': sensitivity, 'specificity': specificity})
# training
num_epochs = 500
