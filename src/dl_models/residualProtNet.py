...
# sequence layers
# x = Reshape(target_shape=(1, 21, 512))(x)
...
# callbacks
mcp_save = keras.callbacks.callbacks.ModelCheckpoint('saved_models/rpn.h5', save_best_only=True, monitor='val_accuracy', verbose=1)
